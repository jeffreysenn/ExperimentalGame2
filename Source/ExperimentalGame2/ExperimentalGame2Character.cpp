...
//////////////////////////////////////////////////////////////////////////
// AExperimentalGame2Character

AExperimentalGame2Character::AExperimentalGame2Character()
{
...
void AExperimentalGame2Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AExperimentalGame2Character::MoveForward);
	//PlayerInputComponent->BindAxis("MoveRight", this, &AExperimentalGame2Character::MoveRight);
	...
	PlayerInputComponent->BindTouch(IE_Released, this, &AExperimentalGame2Character::TouchStopped);
...
void AExperimentalGame2Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AExperimentalGame2Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
...
//void AExperimentalGame2Character::MoveRight(float Value)
//{
//	if ( (Controller != NULL) && (Value != 0.0f) )
//	{
